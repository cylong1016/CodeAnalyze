...
//            console.log(detail_info);
        ...
        function drawDetailPanel(obj) {
            ...
            $.each(detail_warn, function (key, value) {
                ...
                html_warn.push(key+'  第'+ $.inArray(key, detail_timeline) + '次检查');
                ...
                html_warn.push('<thead><tr><td>data1</td><td>data2</td></tr></thead>');
...
//            $.each($('.warn-table'), function (index, obj) {
//                obj.DataTable();
//            });
        }
