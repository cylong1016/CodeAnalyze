...
//	        connection.setRequestProperty("api_token", "2drew0z1Eifw2P5g7jBO");
	        connection.setRequestProperty("project_token", "ca9b21f8596c4f83b1943ce20cc249d5");
			// 建立实际的连接
			connection.connect();
			// 获取所有响应头字段
...
//	            conn.setRequestProperty("api_token", "2drew0z1Eifw2P5g7jBO");
	...
	public static void main(String[] args) {
		// 发送 GET 请求
//		https://api.codacy.com/2.0/864986781/tss/commit/3537d8d079447283bc4651a381c7145e5e244f4c
//		String s=NewTestRequest.sendGet("https://api.codacy.com/2.0/project",
//		 "");
//		System.out.println(s);

		// 发送 POST 请求
//		https://api.codacy.com/2.0/864986781/tss/commit/3537d8d079447283bc4651a381c7145e5e244f4c/analyse
//		String sr = NewTestRequest.sendPost(
//				"https://api.codacy.com/2.0/project/delete",
//				"");
